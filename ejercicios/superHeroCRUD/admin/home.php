...
<div id="wrapper">
    ...
    switch ($page) {
        case 'guest':
            include './includes/navs/navGuest.inc.php';
            break;
        case 'user':
            include './includes/navs/navUser.inc.php';
            break;
        case 'superhero':
            include './includes/navs/navSuperHero.inc.php';
            break;
        case 'result':
            include './includes/navs/navResult.inc.php';
            break;
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <!-- Topbar Search -->
                <form method="post" action="./actions/search.act.php"
                        ...
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <img class="img-profile rounded-circle"
                                 src="../assets/bootstrap/img/undraw_profile.svg" alt="photo">
                        </a>
            ...
            <main>
                ...
                <h1 class="h1ListSH">Listado SuperHeroes</h1>

                <div>

                    <?php

                    include "./includes/listSuperheroes.inc.php";
                    ...
                    if($search !== null){
                            ...
                            <div class="container">
                                <div>
                                    <h1 class="h1ListSH">Resultado Busqueda</h1></div>
                                <div class="row">
                                    ...
                                    <div class="row cuadroListado">
                                        <div class="col-lg-12">
                                            ...
                                            <table class="table">
                                                ...
                                                $sqlList = $connection->query("SELECT * FROM superheroes WHERE nombre LIKE '%$search%'");
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; Website SuperHeroes</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
